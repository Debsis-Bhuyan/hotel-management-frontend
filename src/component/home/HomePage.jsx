...
import HeaderImage from '../../assets/images/hotel.webp';
import AirConditioningImage from '../../assets/images/ac.png';
import MiniBarImage from '../../assets/images/mini-bar.png';
import ParkingImage from '../../assets/images/parking.png';
import WifiIamge from '../../assets/images/wifi.png';
    ...
    return (
        <div className="home">
            ...
            <section className="service-section"><div className="service-card">
                <img src={AirConditioningImage} alt="Air Conditioning" />
                ...
                <div className="service-card">
                    <img src={MiniBarImage} alt="Mini Bar" />
                    <div className="service-details">
